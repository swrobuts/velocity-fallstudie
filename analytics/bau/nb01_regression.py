...
1. **`distanz_km` fehlt bei rund 41 % der Fahrten.** Das ist kein Tippfehler, sondern
...
- Beim **CITY-Rad** hält das Modell das Kriterium (0,464 € gegen 0,50 € Schwelle). Bei
  0,10 €/Minute darf man sich knapp fünf Minuten irren — und genau so gut ist das Modell.
- Beim **EBIKE** (1,01 €) und erst recht beim **CARGO-Rad** (3,09 €) reißt es das
...
|---|---|---|
| **CITY** | **Freigabe** | Kriterium erfüllt (0,464 € < 0,50 €). Betrifft rund 53 % aller Fahrten — der Nutzen ist real. |
| **EBIKE** | **Rücksprung** | 1,01 € — mehr als doppelt so hoch wie erlaubt |
| **CARGO** | **Rücksprung** | 3,09 € — die Punktschätzung ist hier die falsche Zusage |
...
|---|---|
| Testmenge (Phase 5) | **0,464 €** — Kriterium erfüllt |
| Schattenbetrieb, letzte 30 Tage | **0,493 €** — gerade eben gehalten, aber ohne Reserve |
...
| 5 Evaluation | Über alle Räder gemittelt **gerissen** (0,91 €) — nach Radtyp getrennt besteht CITY (0,464 €), EBIKE und CARGO fallen durch. Lange Fahrten werden systematisch unterschätzt |
