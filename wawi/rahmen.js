...
const UEBERSETZUNGEN = {
  de: {
    ...
    "index.demoHinweis": "Zum Ausprobieren: Anmeldung „demo“, Kennwort „demodemo“ – nur Lesen, keine Änderungen.",
  ...
  en: {
    ...
    "index.demoHinweis": "To try it out: sign in “demo”, password “demodemo” – read-only, no changes.",
  ...
  tr: {
    ...
    "index.demoHinweis": "Denemek için: “demo” / “demodemo” ile giriş yapın – yalnızca okuma, değişiklik yapılamaz.",
  ...
  es: {
    ...
    "index.demoHinweis": "Para probar: inicie sesión con “demo”, contraseña “demodemo” – solo lectura, sin cambios.",
  ...
  it: {
    ...
    "index.demoHinweis": "Per provare: accedi con “demo”, password “demodemo” – sola lettura, nessuna modifica.",
  ...
  pl: {
    ...
    "index.demoHinweis": "Aby wypróbować: zaloguj się „demo”, hasło „demodemo” – tylko odczyt, bez zmian.",
