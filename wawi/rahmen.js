...
const UEBERSETZUNGEN = {
  de: {
    ...
    "index.demoHinweis": "Zum Ausprobieren: Anmeldung „demo@wawi.invalid“, Kennwort „demodemo“ – nur Lesen, keine Änderungen.",
    ...
    "field.gewichtKg": "Gewicht (kg)",
    "field.kaufdatum": "Kaufdatum",
    "field.erstinbetriebnahme": "Erstinbetriebnahme",
    "misc.ohneMotor": "ohne Motor",
    "misc.nabenschaltung": "{n}-Gang Nabenschaltung",
    "wert.vantaa_m50": "Vantaa Motion M50",
    "wert.vantaa_c85": "Vantaa Motion C85",
    "field.farbe": "Farbe",
    "field.rahmenform": "Rahmenform",
    "field.schaltung": "Schaltung",
    "field.bremsen": "Bremsen",
    "field.beleuchtung": "Beleuchtung",
    "field.motortyp": "Motortyp",
    "field.reifengroesse": "Reifengröße (Zoll)",
    "field.schlossnummer": "Schlossnummer",
    "wert.diamant": "Diamant",
    "wert.tiefeinsteiger": "Tiefeinsteiger",
    "wert.nabe": "Nabenschaltung",
    "wert.keine": "keine",
    "wert.felge": "Felgenbremse",
    "wert.scheibe": "Scheibenbremse",
    "wert.nabendynamo": "Nabendynamo",
    "wert.akku": "Akkulicht",
    "msg.gewichtFehlt": "Bitte das Gewicht des Rades angeben.",
    "field.status": "Status",
    ...
    "tab.checkList": "Prüfliste",
    "field.platz": "Platz",
    "field.nutzung": "Nutzung",
    "field.dringlichkeit": "Dringlichkeit",
    "field.fahrzeit": "Fahrminuten seit der Reparatur",
    "field.typMedian": "Median des Radtyps (Minuten)",
    "field.messabdeckung": "Davon mit gemessener Strecke",
    "field.gueltigBis": "Gültig bis",
    "misc.urgencyFirst": "zuerst",
    "misc.urgencyNext": "danach",
    "misc.urgencyIfTime": "wenn Zeit bleibt",
    "misc.checkListTitle": "Rad {rahmennummer}, Platz {rang}",
    "misc.neverRepaired": "noch nie repariert",
    "msg.checkListLoadFailed": "Die Prüfliste ließ sich nicht laden: {fehler}",
    "msg.checkListCount": "{raederPhrase}, Stand {stichtag}, nachprüfbar ab {gueltigBis} — Probelauf, die Liste ordnet keine Reparatur an.",
    "empty.noCheckListTitle": "Noch keine Prüfliste",
    "empty.noCheckListText": "Für diesen Bestand wurde noch keine Prüfliste eingefroren.",
  ...
  en: {
    ...
    "index.demoHinweis": "To try it out: sign in “demo@wawi.invalid”, password “demodemo” – read-only, no changes.",
    ...
    "field.gewichtKg": "Weight (kg)",
    "field.kaufdatum": "Purchase date",
    "field.erstinbetriebnahme": "First put into service",
    "misc.ohneMotor": "no motor",
    "misc.nabenschaltung": "{n}-speed hub gears",
    "wert.vantaa_m50": "Vantaa Motion M50",
    "wert.vantaa_c85": "Vantaa Motion C85",
    "field.farbe": "Colour",
    "field.rahmenform": "Frame type",
    "field.schaltung": "Gears",
    "field.bremsen": "Brakes",
    "field.beleuchtung": "Lighting",
    "field.motortyp": "Motor type",
    "field.reifengroesse": "Tyre size (inch)",
    "field.schlossnummer": "Lock number",
    "wert.diamant": "Diamond",
    "wert.tiefeinsteiger": "Step-through",
    "wert.nabe": "Hub gears",
    "wert.keine": "none",
    "wert.felge": "Rim brake",
    "wert.scheibe": "Disc brake",
    "wert.nabendynamo": "Hub dynamo",
    "wert.akku": "Battery light",
    "msg.gewichtFehlt": "Please enter the weight of the bike.",
    "field.status": "Status",
    ...
    "tab.checkList": "Check list",
    "field.platz": "Rank",
    "field.nutzung": "Usage",
    "field.dringlichkeit": "Priority",
    "field.fahrzeit": "Riding minutes since repair",
    "field.typMedian": "Median for this bike type (minutes)",
    "field.messabdeckung": "Of which with measured distance",
    "field.gueltigBis": "Valid until",
    "misc.urgencyFirst": "first",
    "misc.urgencyNext": "next",
    "misc.urgencyIfTime": "if time permits",
    "misc.checkListTitle": "Bike {rahmennummer}, rank {rang}",
    "misc.neverRepaired": "never repaired",
    "msg.checkListLoadFailed": "The check list could not be loaded: {fehler}",
    "msg.checkListCount": "{raederPhrase}, as of {stichtag}, verifiable from {gueltigBis} — trial run, the list does not order any repair.",
    "empty.noCheckListTitle": "No check list yet",
    "empty.noCheckListText": "No check list has been frozen for this fleet yet.",
  ...
  tr: {
    ...
    "index.demoHinweis": "Denemek için: “demo@wawi.invalid” / “demodemo” ile giriş yapın – yalnızca okuma, değişiklik yapılamaz.",
    ...
    "field.gewichtKg": "Ağırlık (kg)",
    "field.kaufdatum": "Satın alma tarihi",
    "field.erstinbetriebnahme": "İlk hizmete alma",
    "misc.ohneMotor": "motorsuz",
    "misc.nabenschaltung": "{n} vitesli göbek dişlisi",
    "wert.vantaa_m50": "Vantaa Motion M50",
    "wert.vantaa_c85": "Vantaa Motion C85",
    "field.farbe": "Renk",
    "field.rahmenform": "Kadro tipi",
    "field.schaltung": "Vites sistemi",
    "field.bremsen": "Frenler",
    "field.beleuchtung": "Aydınlatma",
    "field.motortyp": "Motor tipi",
    "field.reifengroesse": "Lastik ölçüsü (inç)",
    "field.schlossnummer": "Kilit numarası",
    "wert.diamant": "Klasik",
    "wert.tiefeinsteiger": "Alçak eşikli",
    "wert.nabe": "Göbek vites",
    "wert.keine": "yok",
    "wert.felge": "Jant freni",
    "wert.scheibe": "Disk fren",
    "wert.nabendynamo": "Göbek dinamo",
    "wert.akku": "Bataryalı ışık",
    "msg.gewichtFehlt": "Lütfen bisikletin ağırlığını girin.",
    "field.status": "Durum",
    ...
    "tab.checkList": "Kontrol listesi",
    "field.platz": "Sıra",
    "field.nutzung": "Kullanım",
    "field.dringlichkeit": "Öncelik",
    "field.fahrzeit": "Onarımdan bu yana sürüş dakikası",
    "field.typMedian": "Bu bisiklet türünün medyanı (dakika)",
    "field.messabdeckung": "Bunun ölçülen mesafeli kısmı",
    "field.gueltigBis": "Geçerlilik sonu",
    "misc.urgencyFirst": "önce",
    "misc.urgencyNext": "sonra",
    "misc.urgencyIfTime": "zaman kalırsa",
    "misc.checkListTitle": "Bisiklet {rahmennummer}, sıra {rang}",
    "misc.neverRepaired": "hiç onarılmadı",
    "msg.checkListLoadFailed": "Kontrol listesi yüklenemedi: {fehler}",
    "msg.checkListCount": "{raederPhrase}, {stichtag} itibarıyla, {gueltigBis} tarihinden itibaren doğrulanabilir — deneme çalışması, liste hiçbir onarım emri vermez.",
    "empty.noCheckListTitle": "Henüz kontrol listesi yok",
    "empty.noCheckListText": "Bu filo için henüz kontrol listesi dondurulmadı.",
  ...
  es: {
    ...
    "index.demoHinweis": "Para probar: inicie sesión con “demo@wawi.invalid”, contraseña “demodemo” – solo lectura, sin cambios.",
    ...
    "field.gewichtKg": "Peso (kg)",
    "field.kaufdatum": "Fecha de compra",
    "field.erstinbetriebnahme": "Primera puesta en servicio",
    "misc.ohneMotor": "sin motor",
    "misc.nabenschaltung": "Buje interno de {n} marchas",
    "wert.vantaa_m50": "Vantaa Motion M50",
    "wert.vantaa_c85": "Vantaa Motion C85",
    "field.farbe": "Color",
    "field.rahmenform": "Tipo de cuadro",
    "field.schaltung": "Cambio",
    "field.bremsen": "Frenos",
    "field.beleuchtung": "Iluminación",
    "field.motortyp": "Tipo de motor",
    "field.reifengroesse": "Medida de neumático (pulgadas)",
    "field.schlossnummer": "Número de candado",
    "wert.diamant": "Diamante",
    "wert.tiefeinsteiger": "Cuadro bajo",
    "wert.nabe": "Buje interno",
    "wert.keine": "ninguna",
    "wert.felge": "Freno de llanta",
    "wert.scheibe": "Freno de disco",
    "wert.nabendynamo": "Dinamo de buje",
    "wert.akku": "Luz de batería",
    "msg.gewichtFehlt": "Indique el peso de la bicicleta.",
    "field.status": "Estado",
    ...
    "tab.checkList": "Lista de revisión",
    "field.platz": "Puesto",
    "field.nutzung": "Uso",
    "field.dringlichkeit": "Prioridad",
    "field.fahrzeit": "Minutos de marcha desde la reparación",
    "field.typMedian": "Mediana de este tipo de bicicleta (minutos)",
    "field.messabdeckung": "De ellos con distancia medida",
    "field.gueltigBis": "Válida hasta",
    "misc.urgencyFirst": "primero",
    "misc.urgencyNext": "después",
    "misc.urgencyIfTime": "si queda tiempo",
    "misc.checkListTitle": "Bicicleta {rahmennummer}, puesto {rang}",
    "misc.neverRepaired": "nunca reparada",
    "msg.checkListLoadFailed": "No se pudo cargar la lista de revisión: {fehler}",
    "msg.checkListCount": "{raederPhrase}, a fecha de {stichtag}, verificable a partir del {gueltigBis} — ensayo, la lista no ordena ninguna reparación.",
    "empty.noCheckListTitle": "Todavía no hay lista de revisión",
    "empty.noCheckListText": "Para esta flota aún no se ha congelado ninguna lista de revisión.",
  ...
  it: {
    ...
    "index.demoHinweis": "Per provare: accedi con “demo@wawi.invalid”, password “demodemo” – sola lettura, nessuna modifica.",
    ...
    "field.gewichtKg": "Peso (kg)",
    "field.kaufdatum": "Data di acquisto",
    "field.erstinbetriebnahme": "Prima messa in servizio",
    "misc.ohneMotor": "senza motore",
    "misc.nabenschaltung": "Cambio al mozzo a {n} rapporti",
    "wert.vantaa_m50": "Vantaa Motion M50",
    "wert.vantaa_c85": "Vantaa Motion C85",
    "field.farbe": "Colore",
    "field.rahmenform": "Tipo di telaio",
    "field.schaltung": "Cambio",
    "field.bremsen": "Freni",
    "field.beleuchtung": "Illuminazione",
    "field.motortyp": "Tipo di motore",
    "field.reifengroesse": "Misura pneumatico (pollici)",
    "field.schlossnummer": "Numero del lucchetto",
    "wert.diamant": "Diamante",
    "wert.tiefeinsteiger": "Telaio basso",
    "wert.nabe": "Cambio al mozzo",
    "wert.keine": "nessuna",
    "wert.felge": "Freno a cerchio",
    "wert.scheibe": "Freno a disco",
    "wert.nabendynamo": "Dinamo al mozzo",
    "wert.akku": "Luce a batteria",
    "msg.gewichtFehlt": "Indicare il peso della bicicletta.",
    "field.status": "Stato",
    ...
    "tab.checkList": "Lista di controllo",
    "field.platz": "Posto",
    "field.nutzung": "Utilizzo",
    "field.dringlichkeit": "Priorità",
    "field.fahrzeit": "Minuti di marcia dalla riparazione",
    "field.typMedian": "Mediana di questo tipo di bici (minuti)",
    "field.messabdeckung": "Di cui con distanza misurata",
    "field.gueltigBis": "Valida fino al",
    "misc.urgencyFirst": "prima",
    "misc.urgencyNext": "poi",
    "misc.urgencyIfTime": "se resta tempo",
    "misc.checkListTitle": "Bici {rahmennummer}, posto {rang}",
    "misc.neverRepaired": "mai riparata",
    "msg.checkListLoadFailed": "Non è stato possibile caricare la lista di controllo: {fehler}",
    "msg.checkListCount": "{raederPhrase}, al {stichtag}, verificabile dal {gueltigBis} — prova, la lista non ordina alcuna riparazione.",
    "empty.noCheckListTitle": "Nessuna lista di controllo",
    "empty.noCheckListText": "Per questa flotta non è ancora stata congelata alcuna lista di controllo.",
  ...
  pl: {
    ...
    "index.demoHinweis": "Aby wypróbować: zaloguj się „demo@wawi.invalid”, hasło „demodemo” – tylko odczyt, bez zmian.",
    ...
    "field.gewichtKg": "Masa (kg)",
    "field.kaufdatum": "Data zakupu",
    "field.erstinbetriebnahme": "Pierwsze uruchomienie",
    "misc.ohneMotor": "bez silnika",
    "misc.nabenschaltung": "Piasta {n}-biegowa",
    "wert.vantaa_m50": "Vantaa Motion M50",
    "wert.vantaa_c85": "Vantaa Motion C85",
    "field.farbe": "Kolor",
    "field.rahmenform": "Typ ramy",
    "field.schaltung": "Przerzutki",
    "field.bremsen": "Hamulce",
    "field.beleuchtung": "Oświetlenie",
    "field.motortyp": "Typ silnika",
    "field.reifengroesse": "Rozmiar opony (cale)",
    "field.schlossnummer": "Numer zamka",
    "wert.diamant": "Diamentowa",
    "wert.tiefeinsteiger": "Niska rama",
    "wert.nabe": "Piasta",
    "wert.keine": "brak",
    "wert.felge": "Hamulec obręczowy",
    "wert.scheibe": "Hamulec tarczowy",
    "wert.nabendynamo": "Dynamo w piaście",
    "wert.akku": "Światło bateryjne",
    "msg.gewichtFehlt": "Podaj masę roweru.",
    "field.status": "Status",
    ...
    "tab.checkList": "Lista kontrolna",
    "field.platz": "Miejsce",
    "field.nutzung": "Użycie",
    "field.dringlichkeit": "Priorytet",
    "field.fahrzeit": "Minuty jazdy od naprawy",
    "field.typMedian": "Mediana dla tego typu roweru (minuty)",
    "field.messabdeckung": "W tym ze zmierzonym dystansem",
    "field.gueltigBis": "Ważna do",
    "misc.urgencyFirst": "najpierw",
    "misc.urgencyNext": "potem",
    "misc.urgencyIfTime": "jeśli starczy czasu",
    "misc.checkListTitle": "Rower {rahmennummer}, miejsce {rang}",
    "misc.neverRepaired": "nigdy nie naprawiany",
    "msg.checkListLoadFailed": "Nie udało się wczytać listy kontrolnej: {fehler}",
    "msg.checkListCount": "{raederPhrase}, stan na {stichtag}, do sprawdzenia od {gueltigBis} — próba, lista nie zleca żadnej naprawy.",
    "empty.noCheckListTitle": "Brak listy kontrolnej",
    "empty.noCheckListText": "Dla tej floty nie zamrożono jeszcze żadnej listy kontrolnej.",
