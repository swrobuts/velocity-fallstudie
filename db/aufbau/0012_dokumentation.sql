...
comment on column velocity.v_preisschaetzung.startstation      is 'Name der Startstation.';
comment on column velocity.v_preisschaetzung.zielstation       is 'Name der gewaehlten Zielstation.';
comment on column velocity.v_preisschaetzung.typ_code          is 'Fahrradtyp, fuer den die Spanne gilt.';
comment on column velocity.v_preisschaetzung.zeitfenster       is 'frueh, vormittag, nachmittag oder abend.';
comment on column velocity.v_preisschaetzung.minuten_von       is 'Untere Grenze der geschaetzten Dauer in Minuten.';
comment on column velocity.v_preisschaetzung.minuten_bis       is 'Obere Grenze der geschaetzten Dauer in Minuten.';
comment on column velocity.v_preisschaetzung.preis_von         is 'Untere Grenze der angezeigten Preisspanne in Euro.';
comment on column velocity.v_preisschaetzung.preis_bis         is 'Obere Grenze der angezeigten Preisspanne in Euro.';
comment on column velocity.v_preisschaetzung.fahrten_grundlage is 'Zahl der Fahrten, auf denen die Spanne beruht - wird in der App genannt.';
comment on column velocity.v_preisschaetzung.stand             is 'Datum der Berechnung.';
...
comment on view   velocity.v_preisschaetzung is 'Die freigegebenen Preisspannen, wie die Website sie liest. Enthaelt keine Zeile fuer Rundfahrten und keine fuer Verbindungen, deren Spanne die Nuetzlichkeitsregel aus Phase 5.5 des Notebooks reisst (hoechstens 12 Minuten und hoechstens 60 Prozent der Preismitte) - was hier fehlt, wird in der App nicht angezeigt.';
comment on table  velocity.preisschaetzung is 'Ergebnis der Quantilregression aus analytics/notebooks/01_Regression_Fahrtdauer.ipynb: je Verbindung, Radtyp und Tageszeit eine Preisspanne. Enthaelt NUR die freigegebenen Kombinationen - mindestens 30 Fahrten als Grundlage, hoechstens 12 Minuten Spannbreite und hoechstens 60 Prozent der Preismitte. Was fehlt, wird in der App nicht angezeigt.';
...
comment on column velocity.preisschaetzung.typ_code           is 'Fahrradtyp, fuer den die Spanne gilt. Der Minutenpreis unterscheidet sich je Typ, also auch die Euro-Spanne.';
comment on column velocity.preisschaetzung.minuten_von        is 'Untere Grenze der geschaetzten Dauer, aus dem 10-Prozent-Quantil der vergleichbaren Fahrten.';
comment on column velocity.preisschaetzung.minuten_bis        is 'Obere Grenze der geschaetzten Dauer, aus dem 90-Prozent-Quantil. Zusammen decken die beiden Grenzen rund 80 Prozent der tatsaechlichen Fahrten ab.';
comment on column velocity.preisschaetzung.preis_bis          is 'Obere Grenze der angezeigten Spanne in Euro. Die Differenz zu preis_von ist per CHECK auf einen Euro begrenzt - eine breitere Spanne ist ehrlich, aber zum Planen unbrauchbar.';
comment on column velocity.preisschaetzung.stand              is 'Wann die Zeile berechnet wurde. Aeltere Staende sind ein Grund, die Tabelle neu zu laden - vor allem nach einer Tarifaenderung.';
comment on column velocity.preisschaetzung.zeitfenster       is 'frueh (5-10), vormittag (10-15), nachmittag (15-20), abend (20-24). Grober als die Stunde, weil eine Spanne je Stunde auf zu wenigen Fahrten beruhen wuerde.';
comment on column velocity.preisschaetzung.preis_von         is 'Untere Grenze der angezeigten Spanne in Euro, aus dem 10-Prozent-Quantil der Dauer ueber das Tarifblatt gerechnet. ACHTUNG: Aendert sich der Minutenpreis, ist diese Spalte falsch - Tabelle neu laden.';
comment on column velocity.preisschaetzung.fahrten_grundlage is 'Zahl der vergleichbaren Fahrten, auf denen die Spanne beruht. Wird in der App genannt, damit die Schaetzung nachvollziehbar bleibt.';
comment on column velocity.kunde.zeigt_preisschaetzer        is 'Zeigt die App auf den Radkacheln den Knopf fuer die Preisschaetzung? Voreinstellung aus. Die Einstellung haengt am Konto, nicht am Geraet - der Auftraggeber wollte den Vergleich mit und ohne Modell ueber Geraete hinweg vorfuehren koennen.';
